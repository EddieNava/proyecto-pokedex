  ...
  return (
    <article className='principalCard'>
      <div className='header'>
        ...
        <p><span className='span'>Welcome {nameUser}</span>, here you can find your favorite Pokemon.</p>
      </div>
      <div className='filter'>
        <input type="text" placeholder='Search your favorite Pokemon' value={search} onChange={handleChange}/>
      </div>
